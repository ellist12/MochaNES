...
use crate::{bus::Bus, cpu::instructions::{adc::ADC, and::AND, beq::BEQ, bne::BNE, bpl::BPL, clc::CLC, cld::CLD, cmp::CMP, dec::DEC, dex::DEX, dey::DEY, iny::INY, jmp::JMP, jsr::JSR, lda::LDA, ldx::LDX, ldy::LDY, lsr::LSR, pha::PHA, pla::PLA, sei::SEI, sta::STA, sty::STY, tax::TAX, txa::TXA, txs::TXS, tya::TYA}, mochanes::Region};
